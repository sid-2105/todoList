...
useEffect(() => {
  ...
  return (
    ...
    <>
      <div className=" w-screen min-h-screen  overflow-x-hidden overflow-y-auto p-8" 
       style={{
        ...
        <div className="w-full  bg-[#172842] max-w-2xl mx-auto shadow-md rounded-lg px-4 py-3 text-white" >
          ...
          <h1 className=" lg:text-2xl font-bold  text-center sm:text-xl mb-8 mt-2">Manage Your Task Dr. Anjali </h1>
          <div className="mb-4" >
           <TodoForm />
          </div>
